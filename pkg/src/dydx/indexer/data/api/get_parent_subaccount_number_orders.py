...
@dataclass
class GetParentSubaccountOrders(IndexerMixin):
  async def get_parent_subaccount_orders(
    self,
    address: str,
    *,
    ...
    > [Official API docs](https://docs.dydx.xyz/indexer-client/http/accounts#get-parent-subaccount-number-orders)
    """
